...
urlpatterns = [
    ...
    re_path(r"analyze-gene-expr-single$", views.analyze_gene_expr_single, name='analyze-gene-expr-single'),
    re_path(r"analyze-gene-expr-cross$", views.analyze_gene_expr_cross, name='analyze-gene-expr-cross'),
